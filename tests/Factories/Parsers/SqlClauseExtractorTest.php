...
{
	public function testExtractsSelectAndFrom(): void
	{
		$result = SqlClauseExtractor::extract("SELECT id, name FROM users u WHERE id = 1");

		$this->assertSame('id, name', $result->select);
		$this->assertSame('users u', $result->from);
	}
